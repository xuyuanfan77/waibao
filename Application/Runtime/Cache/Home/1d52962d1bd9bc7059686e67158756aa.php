    ...
    <body>
        ...
        <div class="main">
            <div class="width-1000 clear-fix">
                ...
                <div class="js28-nav-box game-two-nav">
                    <div class="two-nav-head">
                        ...
                        <p class="my-touzhu-box clear-fix">
							...
							<a class="my-touzhu-list bor-r sel-color" href="<?php echo U('Automatic/index', array('game'=>'js28'));?>">自动投注</a>
                        </p>
                    </div>
                </div>
                <!-- 公正提示 -->
				...
				<div class="set-out-box js28-box">
							...
							<li class="set-li">
								...
								<div class="set-lir">
									<p class="lir-c1">
										...
										<a href="<?php echo U('Mode/index', array('game'=>'js28'));?>" class="add-mod"><i class="tri"></i><strong>+</strong>添加模式</a>
				...
				<div class="model-out-box js28-box">
					<h4 class="set-h4">设置自动投注期数并开始投注</h4>
					...
					<p class="add-p"><a href="<?php echo U('Mode/index', array('game'=>'js28'));?>" class="add-btn color0">+添加模式</a></p>
					<a href="#" class="autobet-btn J_autobtn" data-url="/waibao/index.php/Home/Automatic/updateAutoStatus" data-game="js28">
