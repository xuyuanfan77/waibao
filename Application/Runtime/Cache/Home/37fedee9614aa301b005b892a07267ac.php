    ...
    <table>
        <tbody>
			...
			<?php if(is_array($gameData)): foreach($gameData as $key=>$data): ?><tr>
					...
					<?php if($data['statu'] == 0): ?><td><span class="js-qus qus-js28"></span></td>
					<?php elseif($data['statu'] == 3): ?>
						<td><?php echo ($data["num1"]); ?>+<?php echo ($data["num2"]); ?>+<?php echo ($data["num3"]); ?>=<span class="js-ball b-js28"><?php echo ($data['num1']+$data['num2']+$data['num3']); ?></span><a target="&#39;_blank&#39;" href="http://game3799.com/lucky28/verification/785251" class="go-yz">验证</a></td>
					<?php else: ?>
						<td><span class="js-qus qus-js28"></span></td><?php endif; ?>
					...
					<?php else: ?>
						<td>-</td><?php endif; ?>
					<?php if($data['statu'] == 0): ?><td><a href="<?php echo U('Guess/index', array('game'=>'js28', 'issue'=>$data['issue']));?>" class="go-jc jc-js28">竞猜</a></td>
