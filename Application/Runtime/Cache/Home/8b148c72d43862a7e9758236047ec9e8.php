            ...
            <div class="width-1000 clear-fix">
                ...
                <div class="luck_insert">
                    ...
                    <div class="across clear-fix" id="panel">
                            ...
                            <?php $__FOR_START_27727__=0;$__FOR_END_27727__=5;for($i=$__FOR_START_27727__;$i < $__FOR_END_27727__;$i+=1){ ?><div class="across_par1_no across_par1_width clear-fix">
                        ...
                        <div class="across_par1 across_par_fksc">
                            <?php $__FOR_START_24540__=5;$__FOR_END_24540__=10;for($i=$__FOR_START_24540__;$i < $__FOR_END_24540__;$i+=1){ ?><div class="across_par1_no across_par1_width clear-fix">
                                    <div class="across_par1_no_left">
											<div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($specialNumName[$i]); ?></div>
                                    </div>
                                    <div style="display: none;">
                        ...
                        <div class="across_par1 ">
								<?php $__FOR_START_2277__=10;$__FOR_END_2277__=20;for($i=$__FOR_START_2277__;$i < $__FOR_END_2277__;$i+=1){ ?><div class="across_par1_no clear-fix">
                                    <div class="across_par1_no_left">
                        ...
                        <div class="across_par1 ">
                            <?php $__FOR_START_16314__=20;$__FOR_END_16314__=28;for($i=$__FOR_START_16314__;$i < $__FOR_END_16314__;$i+=1){ ?><div class="across_par1_no clear-fix">
                                    <div class="across_par1_no_left">
                                        <div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i-10); ?></div>
                                    </div>
                                    <div style="display: none;">
                        ...
                        <div class="across_par1 ">
                            <?php $__FOR_START_32363__=28;$__FOR_END_32363__=38;for($i=$__FOR_START_32363__;$i < $__FOR_END_32363__;$i+=1){ ?><div class="across_par1_no clear-fix">
                                    <div class="across_par1_no_left">
                                        <div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i-10); ?></div>
                                    </div>
                                    <div style="display: none;">
