...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/waibao/Public/front/touzhu-fk28.css">
        ...
        <div class="main">
            <div class="width-1000 clear-fix">
                ...
                <div class="fk28-nav-box game-two-nav">
                    <div class="two-nav-head">
                        ...
                        <p class="my-touzhu-box clear-fix">
							...
							<a class="my-touzhu-list sel-color" href="<?php echo U('Mode/index', array('game'=>'fk28'));?>">投注模式编辑</a>
							<a class="my-touzhu-list bor-r" href="<?php echo U('Automatic/index', array('game'=>'fk28'));?>">自动投注</a>
                        </p>
                    </div>
                </div>
                <!-- 公正提示 -->
				...
				<div class="new_betting_form_right">
					<div class="new_betting_form_right_cap">自定义模式<a id="add_mode" class="a1" href="<?php echo U('Mode/index', array('game'=>'fk28'));?>">+添加新模式</a></div>
			...
			<div class="luck_insert">
				...
				<div class="insert_par1">
					...
					<p class="moshi-edit">当前正在编辑 | <a data-key="0" id="modes_name_2">新模式</a></p>
					<a href="javascript:void(0);" data-url="/Lucky28/BetCurRate" class="the_odds touzhu1 J_refresh_odds">刷新赔率</a>
					<a href="javascript:void(0);" data-url="/Lucky28/GetLastBet" class="the_odds touzhu1 J_last_lottery">上期投注</a>
					<a href="javascript:void(0);" class="the_odds touzhu2">反选</a>
					<a href="javascript:void(0);" class="the_odds touzhu2">清除</a>
				</div>

				<div class="across clear-fix" id="panel">
					<div class="across_par1 ">
						<?php $__FOR_START_4446__=0;$__FOR_END_4446__=10;for($i=$__FOR_START_4446__;$i < $__FOR_END_4446__;$i+=1){ ?><div class="across_par1_no clear-fix">
					...
					<div class="across_par1 ">
						<?php $__FOR_START_14655__=10;$__FOR_END_14655__=18;for($i=$__FOR_START_14655__;$i < $__FOR_END_14655__;$i+=1){ ?><div class="across_par1_no clear-fix">
								<div class="across_par1_no_left">
									<div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
								</div>
								<div style="display: none;">
					...
					<div class="across_par1 ">
						<?php $__FOR_START_16908__=18;$__FOR_END_16908__=28;for($i=$__FOR_START_16908__;$i < $__FOR_END_16908__;$i+=1){ ?><div class="across_par1_no clear-fix">
								<div class="across_par1_no_left">
									<div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
								</div>
								<div style="display: none;">
					...
					<div class="across_par2">
						...
						<p>
							<a href="javascript:void(0);" data-url="/waibao/index.php/Home/Mode/save" data-id="" data-game="fk28" class="save_btn mode_save J_moshi_save">保存</a>
