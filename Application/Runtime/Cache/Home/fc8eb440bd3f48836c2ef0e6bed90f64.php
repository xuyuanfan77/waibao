                ...
                <p class="kaijiang-time-text mar-t">距离第 <b><?php echo ($tipData['issue']+1); ?></b> 期竞猜截止还有 <b class="J_jcTime" data-lasttime="<?php echo ($tipData['deadlinecd']); ?>"><?php echo ($tipData['deadlinecd']); ?></b> 秒 开奖还有 <b class="J_kjTime" data-lasttime="<?php echo ($tipData['runtimecd']); ?>"><?php echo ($tipData['runtimecd']); ?></b> 秒 </p>
                    <p class="kaijiang-time-text">
                        第<strong><?php echo ($tipData["issue"]); ?></strong>期开奖结果：<?php echo ($tipData["num1"]); ?>+<?php echo ($tipData["num2"]); ?>+<?php echo ($tipData["num3"]); ?>=<span class="now-jieguo"><?php echo ($tipData['num1']+$tipData['num2']+$tipData['num3']); ?></span>
                            <a target="_blank" href="http://www.tlotto.kr/">[官方查询]</a>
                        <a href="http://www.game3799.com/speed28/guide">[游戏帮助]</a>
                    </p>
            </div>
				...
				<div class="luck_insert">
					...
					<div class="across clear-fix" id="panel">
						<div class="across_par1 ">
							<?php $__FOR_START_4377__=0;$__FOR_END_4377__=10;for($i=$__FOR_START_4377__;$i < $__FOR_END_4377__;$i+=1){ ?><div class="across_par1_no clear-fix">
						...
						<div class="across_par1 ">
							<?php $__FOR_START_5598__=10;$__FOR_END_5598__=18;for($i=$__FOR_START_5598__;$i < $__FOR_END_5598__;$i+=1){ ?><div class="across_par1_no clear-fix">
									<div class="across_par1_no_left">
											<div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
									</div>
									<div style="display: none;">
						...
						<div class="across_par1 ">
							<?php $__FOR_START_9151__=18;$__FOR_END_9151__=28;for($i=$__FOR_START_9151__;$i < $__FOR_END_9151__;$i+=1){ ?><div class="across_par1_no clear-fix">
									<div class="across_par1_no_left">
											<div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
									</div>
									<div style="display: none;">
						...
						<div class="across_par2">
							...
							<p><a href="javascript:void(0);" data-game="js28" data-issue="<?php echo ($issueNum); ?>" data-url="/waibao/index.php/Home/Guess/guess" class="suer_insert J_TZBtn">确认投注</a></p>
						</div>
					</div>
				</div>
				<!-- 内容  end	 -->
