                ...
                <div class="luck_insert">
                    ...
                    <div class="across clear-fix" id="panel">
                        <div class="across_par1 ">
                            <?php $__FOR_START_13009__=0;$__FOR_END_13009__=10;for($i=$__FOR_START_13009__;$i < $__FOR_END_13009__;$i+=1){ ?><div class="across_par1_no clear-fix">
                        ...
                        <div class="across_par1 ">
                            <?php $__FOR_START_310__=10;$__FOR_END_310__=18;for($i=$__FOR_START_310__;$i < $__FOR_END_310__;$i+=1){ ?><div class="across_par1_no clear-fix">
                                    <div class="across_par1_no_left">
                                        <div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
                                    </div>
                                    <div style="display: none;">
                        ...
                        <div class="across_par1 ">
                            <?php $__FOR_START_10295__=18;$__FOR_END_10295__=28;for($i=$__FOR_START_10295__;$i < $__FOR_END_10295__;$i+=1){ ?><div class="across_par1_no clear-fix">
                                    <div class="across_par1_no_left">
                                        <div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
                                    </div>
                                    <div style="display: none;">
                        ...
                        <div class="across_par2">
                            ...
                            <p>
                                <a href="javascript:void(0);" data-game="js28" data-issue="<?php echo ($issueNum); ?>" data-url="/waibao/index.php/Home/Guess/guess" class="suer_insert J_TZBtn">
                                    确认投注
                                </a>
                            </p>
                        </div>
