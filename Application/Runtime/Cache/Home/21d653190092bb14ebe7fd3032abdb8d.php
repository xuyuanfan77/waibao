            ...
            <div class="J_kjTimeBox">
                <p class="kaijiang-time-text mar-t">距离第 <b><?php echo ($tipData['issue']+1); ?></b> 期竞猜截止还有 <b class="J_jcTime" data-lasttime="<?php echo ($tipData['deadlinecd']); ?>"><?php echo ($tipData['deadlinecd']); ?></b> 秒 开奖还有 <b class="J_kjTime" data-lasttime="<?php echo ($tipData['runtimecd']); ?>"><?php echo ($tipData['runtimecd']); ?></b> 秒 </p>
                    <p class="kaijiang-time-text">
                        第<strong><?php echo ($tipData["issue"]); ?></strong>期开奖结果：<span class="fk-car car<?php echo ($tipData['num1']); ?>"></span>
				...
				<div class="luck_insert">
					...
					<div class="across clear-fix" id="panel">
						<div class="across_par1 across_par_fksc">
							<?php $__FOR_START_8436__=1;$__FOR_END_8436__=6;for($i=$__FOR_START_8436__;$i < $__FOR_END_8436__;$i+=1){ ?><div class="across_par1_no across_par1_width clear-fix">
									...
									<div class="across_par1_no_right">
										<p>
											<input class="downhhhh input_modou_txt_null" name="mdp_coin" id="txt<?php echo ($i); ?>" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" maxlength="15" type="text"><a style="display: none;" class="sack_02" href="javascript:void(0);" onclick="clear_input('txt<?php echo ($i); ?>',this);" id="clear_this_val<?php echo ($i); ?>"></a>
											<span style="display: none;" id="peilv<?php echo ($i); ?>">
											<label>×</label><a href="javascript:void(0);" class="multiple" id="<?php echo ($i); ?>" val="0.1">.1</a><a href="javascript:void(0);" id="<?php echo ($i); ?>" val="0.5" class="multiple">.5</a><a href="javascript:void(0);" id="<?php echo ($i); ?>" val="2" class="multiple">2</a><a href="javascript:void(0);" id="<?php echo ($i); ?>" val="10" class="multiple">10</a></span>
										</p>
										<p>
											当前赔率:<span class="color_02" id="this_lottery_odds<?php echo ($i); ?>"><?php echo ($gameOdds[$i-1]); ?></span>| 上期赔率:<span id="last_lottery_odds<?php echo ($i); ?>"><?php echo ($preGameOdds[$i-1]); ?></span>
										</p>
									</div>
								</div><?php } ?>
						</div>
						...
						<div class="across_par1 across_par_fksc">
							<?php $__FOR_START_4125__=6;$__FOR_END_4125__=11;for($i=$__FOR_START_4125__;$i < $__FOR_END_4125__;$i+=1){ ?><div class="across_par1_no across_par1_width clear-fix">
									<div class="across_par1_no_left">
										<div id="click_number<?php echo ($i); ?>" class="click_number sc_left_logo sc_logo_0<?php echo ($i); ?>" style="cursor: pointer;"></div>
									</div>
									<div style="display: none;">
						...
						<div class="across_par2">
							...
							<p><a href="javascript:void(0);" data-game="fksc" data-issue="<?php echo ($issueNum); ?>" data-url="/waibao/index.php/Home/Guess/guess" class="suer_insert J_TZBtn">确认投注</a></p>
						</div>
					</div>
				</div>
				<!-- 内容  end	 -->
