			...
			<div class="luck_insert">
				...
				<div class="across clear-fix" id="panel">
					<div class="across_par1 ">
						<?php $__FOR_START_22612__=0;$__FOR_END_22612__=10;for($i=$__FOR_START_22612__;$i < $__FOR_END_22612__;$i+=1){ ?><div class="across_par1_no clear-fix">
					...
					<div class="across_par1 ">
						<?php $__FOR_START_25597__=10;$__FOR_END_25597__=18;for($i=$__FOR_START_25597__;$i < $__FOR_END_25597__;$i+=1){ ?><div class="across_par1_no clear-fix">
								<div class="across_par1_no_left">
									<div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
								</div>
								<div style="display: none;">
					...
					<div class="across_par1 ">
						<?php $__FOR_START_22770__=18;$__FOR_END_22770__=28;for($i=$__FOR_START_22770__;$i < $__FOR_END_22770__;$i+=1){ ?><div class="across_par1_no clear-fix">
								<div class="across_par1_no_left">
									<div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
								</div>
								<div style="display: none;">
