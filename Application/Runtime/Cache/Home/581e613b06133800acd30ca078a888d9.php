                ...
                <div class="luck_insert">
                    ...
                    <div class="across clear-fix" id="panel">
                        <div class="across_par1 ">
                            <?php $__FOR_START_16780__=3;$__FOR_END_16780__=9;for($i=$__FOR_START_16780__;$i < $__FOR_END_16780__;$i+=1){ ?><div class="across_par1_no clear-fix">
                        ...
                        <div class="across_par1 ">
                            <?php $__FOR_START_16597__=9;$__FOR_END_16597__=13;for($i=$__FOR_START_16597__;$i < $__FOR_END_16597__;$i+=1){ ?><div class="across_par1_no clear-fix">
                                    <div class="across_par1_no_left">
                                        <div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
                                    </div>
                                    <div style="display: none;">
                        ...
                        <div class="across_par1 ">
                            <?php $__FOR_START_12522__=13;$__FOR_END_12522__=19;for($i=$__FOR_START_12522__;$i < $__FOR_END_12522__;$i+=1){ ?><div class="across_par1_no clear-fix">
                                    <div class="across_par1_no_left">
                                        <div id="click_number<?php echo ($i); ?>" class="click_number no_left_bg" style="cursor: pointer;"><?php echo ($i); ?></div>
                                    </div>
                                    <div style="display: none;">
