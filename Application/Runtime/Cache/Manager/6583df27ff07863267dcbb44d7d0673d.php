...
<div class="col-md-10">
	<a type="button" class="btn btn-default" href="<?php echo U('Guess/index');?>" style="float:right;margin:15px 0px">取消修改</a>
	<button type="button" class="btn btn-default" onclick="submitForm()" style="float:right;margin:15px 0px">保存配置</button>
	<form id="information" enctype="multipart/form-data" action="<?php echo U('Guessform/save');?>" method="post" role="form">
